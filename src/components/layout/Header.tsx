  ...
  return (
    <header className="relative overflow-hidden border-b border-indigoInk/10 bg-white">
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-white/92 via-white/72 to-white/88" />
      </div>
      <div className="relative mx-auto max-w-7xl px-4 py-5 sm:px-6 lg:px-8">
        <div className="rounded-lg border border-white/75 bg-white/72 p-4 shadow-soft backdrop-blur-md">
